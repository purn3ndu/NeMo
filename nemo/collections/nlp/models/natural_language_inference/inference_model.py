...
class NLIModel(NLPModel):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        """
        Initializes model to use BERT model for NLI tasks.
        """
        ...
        #<AYAN 26th OCT 2020 9:36AM>not sure if task name is required here, 
        # we are only doing NLI, for now this remains to ensure compatibility.
        #cfg.supported_tasks.remove('sts-b')   
